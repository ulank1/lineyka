package dada.lineykaapp.widget;
...
import dada.lineykaapp.activities.Shared;
import dada.lineykaapp.utils.RulerUtils;

/**
 * Created by Toan Vu on 4/1/16.
 */
public class RulerView extends View {
    int s[]={16,16,16,17,17,18,18,19,19,20,20,21,22,22,23,24,25,25,26,27,28,29,30,31,32,34,35,36,38,39,41,43,45,47,49,51,54};
    ...
    public void onDraw(Canvas canvas) {
       ...
       try {
           canvas.drawText(String.valueOf(s[(int) result]), 30, height - 20 + 8, textPaint);
           Shared.pressure = s[(int) result]+"";
       }catch (Exception e){
...
//        Typeface typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
   //     textPaint.setTypeface(typeface);
        ...
        textPaint.setTextSize(getResources().getDimension(R.dimen.scale_line_3));
    ...
    private double calculateMeasure() {
        ...
        /*
        double c= (7.8-distance)*15.0557;
        double d = c/0.99780014;
        d/=1.5;
        Log.e("DD",d+"");
        Log.e("---------------------","---------------------------------");
        d=Math.round(d);*/
        ...
        double d = distance/(0.35/54)/15;*/

//2.0307
        distance=distance-3.9793;
        double d = distance/((7.5353-3.9793)/540)/15;


        try {
            Log.e("dddd",s[(int) Math.round(d)]+"");
        } catch (Exception e) {
            e.printStackTrace();
        }
